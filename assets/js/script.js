...
function calculateDueDate() {
    ...
    if (lastPeriod.isValid()) {
        ...
        document.getElementById('due-date').innerHTML = "Data estimată a conceperii: <strong>" + conceptionDate.format('DD/MM/YYYY') +
                                                        "</strong><br>Data probabilă a nașterii: <strong>" + dueDate.format('DD/MM/YYYY') + '</strong>';
    } else {
        document.getElementById('due-date').innerHTML = "Vă rugăm să introduceți o dată validă.";
    }
}
